@for($e=0;$e<$product->rating;$e++)
    <a class="text-primary @if($vote) js-vote @endif" data-value="{{$e+1}}" style="cursor: pointer" role="button">
...
@for($e=($product->rating);$e<5;$e++)
    <a class="text-muted @if($vote) js-vote @endif" data-value="{{$e+1}}" style="cursor: pointer" role="button">
