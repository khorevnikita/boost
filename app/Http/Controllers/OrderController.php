...
// Handle the event
    ...
    public function paypalCallback(Request $request)
    {
        ...
        $example = '{"id":"WH-50P75126SV507294L-0A883818YN266033E","event_version":"1.0","create_time":"2021-06-30T12:07:33.301Z","resource_type":"checkout-order","resource_version":"2.0","event_type":"CHECKOUT.ORDER.APPROVED","summary":"An order has been approved by buyer","resource":{"create_time":"2021-06-30T12:06:46Z","purchase_units":[{"reference_id":"281","amount":{"currency_code":"USD","value":"17.85"},"payee":{"email_address":"sb-43l7zw6659471@business.example.com","merchant_id":"26MT54MEDXGMW"},"shipping":{"name":{"full_name":"John Doe"},"address":{"address_line_1":"Whittaker House","address_line_2":"2 Whittaker Avenue","admin_area_2":"Richmond","admin_area_1":"Surrey","postal_code":"TW9 1EH","country_code":"GB"}}}],"links":[{"href":"https:\/\/api.sandbox.paypal.com\/v2\/checkout\/orders\/93M47888KU395805N","rel":"self","method":"GET"},{"href":"https:\/\/api.sandbox.paypal.com\/v2\/checkout\/orders\/93M47888KU395805N","rel":"update","method":"PATCH"},{"href":"https:\/\/api.sandbox.paypal.com\/v2\/checkout\/orders\/93M47888KU395805N\/capture","rel":"capture","method":"POST"}],"id":"93M47888KU395805N","intent":"CAPTURE","payer":{"name":{"given_name":"John","surname":"Doe"},"email_address":"sb-ks7yn6652738@personal.example.com","payer_id":"TQ9XW286HUDZ8","address":{"country_code":"GB"}},"status":"APPROVED"},"links":[{"href":"https:\/\/api.sandbox.paypal.com\/v1\/notifications\/webhooks-events\/WH-50P75126SV507294L-0A883818YN266033E","rel":"self","method":"GET"},{"href":"https:\/\/api.sandbox.paypal.com\/v1\/notifications\/webhooks-events\/WH-50P75126SV507294L-0A883818YN266033E\/resend","rel":"resend","method":"POST"}]}';
